...
alias gf1='git fetch --verbose $(gb-tr)'
...
b() {
  ...
  noglob git branch -vv --sort=refname --list "${pattern}"
}
bb() {
...
alias goneDC='gh-st-all --closed | tee /dev/tty | cut -f1 | xargs -r -n1 -p git branch --delete --force'
