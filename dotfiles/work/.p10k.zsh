## Work Profile: .p10k.zsh
## -------------------------------------------------------------------------------------------------

# Generated by Powerlevel10k configuration wizard on 2025-06-14 at 07:56 PDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIINS_CONTENT_EXPANSION='$'
  # typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIINS_CONTENT_EXPANSION=$'%{\033]133;A\007%}$'
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='kubectl|skaffold'
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEFAULT_BACKGROUND=99
  ...
  typeset -g POWERLEVEL9K_GCLOUD_BACKGROUND=26
  ...
  POWERLEVEL9K_GCLOUD_COMPLETE_CONTENT_EXPANSION='${P9K_GCLOUD_CONFIGURATION//\%/%%}'
  POWERLEVEL9K_GCLOUD_COMPLETE_CONTENT_EXPANSION+='${${:-/$P9K_GCLOUD_PROJECT_ID}:#/$P9K_GCLOUD_CONFIGURATION}'
